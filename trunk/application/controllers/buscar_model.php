...
class Buscar_model extends CI_Model {
    ...
    function buscar_avisos($tipoOp, $tipoPro, $ciudad, $provincia) {
		...
		// El cero representa que la busqueda se aplica a todas las provincias
		if($provincia != 0) {
			$this->db->where('localidades.id_provincia',$provincia);
		}
