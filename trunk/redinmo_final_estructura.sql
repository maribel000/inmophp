...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2015 a las 16:28:05
...
(2, 'inmobiliarias', 'Usuario de tipo inmobiliaria'),
(3, 'particulares', 'Usuario de tipo particular'),
(4, 'clientes', 'Usuario de tipo cliente');
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1423235567, 1, 'Admin', 'istrator', 'ADMIN', '0');
