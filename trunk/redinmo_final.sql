...
--
-- Dumping data for table `aviso_fotos`
--
...
--
-- Dumping data for table `enviado_mail`
--

LOCK TABLES `enviado_mail` WRITE;
/*!40000 ALTER TABLE `enviado_mail` DISABLE KEYS */;
INSERT INTO `enviado_mail` VALUES (1,1,'lbanco@gmail.com','192.168.100.100','2015-01-05 00:00:00'),(2,2,'nahuel9000@gmail.com','192.168.100.102','2014-12-20 00:00:00');
/*!40000 ALTER TABLE `enviado_mail` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `groups` VALUES (1,'Administrator','',NULL),(2,'Usuarios','',NULL);
...
--
-- Dumping data for table `inmuebles_caracteristicas`
--

LOCK TABLES `inmuebles_caracteristicas` WRITE;
/*!40000 ALTER TABLE `inmuebles_caracteristicas` DISABLE KEYS */;
INSERT INTO `inmuebles_caracteristicas` VALUES (1,1,1,'Gran piscina de hormigon solarium'),(2,2,2,'Parrillero mediano con salida ubicado en el p'),(3,3,6,'Terraza con tendedor');
/*!40000 ALTER TABLE `inmuebles_caracteristicas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `login_attempts` VALUES (1,'200.3.120.222','nrullo',2014),(2,'200.3.120.222','nrullo',2014);
...
INSERT INTO `mensajes` VALUES (4,2,1,'2014-01-02 00:00:00','¿Está disponible?'),(5,3,2,'2014-12-02 00:00:00','¿En qué horario se la puede ver?');
...
INSERT INTO `paises` VALUES (1,'AR','Argentina');
...
--
-- Dumping data for table `tipos_inmuebles_caracteristicas`
--

LOCK TABLES `tipos_inmuebles_caracteristicas` WRITE;
...
--
-- Dumping data for table `user_busquedas`
--

LOCK TABLES `user_busquedas` WRITE;
/*!40000 ALTER TABLE `user_busquedas` DISABLE KEYS */;
INSERT INTO `user_busquedas` VALUES (1,1,'2014-01-02 20:00:00','rosario departamento'),(2,2,'2014-01-02 00:00:01','zona norte alquiler'),(3,2,'2014-01-21 00:00:00','venta casa conurbano');
/*!40000 ALTER TABLE `user_busquedas` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `user_favoritos` WRITE;
/*!40000 ALTER TABLE `user_favoritos` DISABLE KEYS */;
INSERT INTO `user_favoritos` VALUES (1,1,2,'2015-01-22 10:00:00'),(2,2,1,'2015-01-23 10:00:00'),(3,2,3,'2015-01-29 10:00:00');
/*!40000 ALTER TABLE `user_favoritos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `user_pedidos`
--

LOCK TABLES `user_pedidos` WRITE;
/*!40000 ALTER TABLE `user_pedidos` DISABLE KEYS */;
INSERT INTO `user_pedidos` VALUES (1,1,1,1,34,1000,6000,NULL),(2,2,1,1,23,1000,99999,NULL);
/*!40000 ALTER TABLE `user_pedidos` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `ver_datos` WRITE;
/*!40000 ALTER TABLE `ver_datos` DISABLE KEYS */;
INSERT INTO `ver_datos` VALUES (1,1,'203.12.23.51','2015-01-22 10:00:00'),(2,2,'200.12.12.99','2015-01-25 10:00:00');
/*!40000 ALTER TABLE `ver_datos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `visualizaciones` VALUES (0,1,20112,'2015-10-20 00:00:00'),(0,2,199123,'2015-01-20 00:00:00');
