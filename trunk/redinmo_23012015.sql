...
INSERT INTO `avisos` (`id`, `id_tipo_inmueble`, `tipo_op`, `id_barrio`, `direccion`, `metros_cuadrados`, `cant_ambientes`, `cant_dormitorios`, `cant_banios`, `estado_inmueble`, `anio`, `detalles`, `precio`, `id_usuario`, `fecha`, `estado_aviso`) VALUES
(1, 0, 0, 'barrio', 'direccion', 4, 1, 2, 3, '5', 6, 'detallessss', 7777, 0, '0000-00-00 00:00:00', ''),
(2, 2, 1, 'empalme', 'cavour 554', 0, 0, 0, 0, '', 0, 'muy buena cochera!', 450, 0, '0000-00-00 00:00:00', ''),
(3, 2, 1, 'empalme', 'cavour 554', 0, 0, 0, 0, '', 0, 'muy buena cochera!', 450, 0, '0000-00-00 00:00:00', ''),
(4, 0, 0, '', '', 0, 0, 0, 0, '', 0, 'deta', 0, 0, '0000-00-00 00:00:00', '');
...
`id` int(11) NOT NULL,
  `nombre` varchar(40) NOT NULL,
  `prefijo_tel` varchar(7) NOT NULL,
...
INSERT INTO `localidades` (`id`, `nombre`, `prefijo_tel`, `id_provincia`) VALUES
(1, 'Rosario', '341', 1);
...
INSERT INTO `paises` (`id`, `codigo`, `nombre`, `prefijo_tel`) VALUES
(1, 'AR', 'Argentina', '+54'),
(2, 'UY', 'Uruguay', '+598');
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `activo`, `nombre`, `apellido`, `id_localidad`, `nro_tel`) VALUES
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1419890475, 1, 'Admin', 'istrator', 1, '0'),
(2, '127.0.0.1', 'lucas blanco', '0', NULL, 'lucasblanco@gmail.com', NULL, NULL, NULL, NULL, 1419629701, NULL, 1, 'Lucas', 'Blanco', 1, '4303030');
...
--
-- Volcado de datos para la tabla `usuario_busquedas`
--

INSERT INTO `usuario_busquedas` (`id_usuario`, `id_busqueda`, `fecha_hora`, `cadena`) VALUES
(1, 0, '2015-01-16 00:00:00', NULL),
(1, 1, '2015-01-08 09:27:39', NULL),
(1, 4, '2015-01-02 00:00:00', NULL),
(2, 5, '2015-01-29 00:00:00', NULL);
...
--
ALTER TABLE `paises`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `unique_codigo` (`codigo`), ADD UNIQUE KEY `unique_prefijo_tel` (`prefijo_tel`);
